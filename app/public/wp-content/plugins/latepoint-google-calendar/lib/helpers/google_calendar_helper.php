...
class OsGoogleCalendarHelper {
  ...
  //Sandy : not in use =>replaced by get_gcal_event_recurrences_bis cf functions.php
  ...
  ///Sandy : not in use =>replaced by create_or_update_google_event_in_db_bis - cf functions.php
  ...
  /* public static function create_or_update_google_event_in_db($google_event_id, $agent_id){
   ...
   //Sandy : not in use =>replaced by create_or_update_booking_in_gcal - cf functions.php
