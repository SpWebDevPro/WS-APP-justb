			...
			<div class="step-body">
				<div class="os-form-w">
				  <form data-os-action="<?php echo OsRouterHelper::build_route_name('settings', 'update_step'); ?>" action="">
					...
					<div class="latepoint-message latepoint-message-subtle">La description courte du step indique au client, dans l'application, l'étape de réservation et ce qu'il doit faire </div>
