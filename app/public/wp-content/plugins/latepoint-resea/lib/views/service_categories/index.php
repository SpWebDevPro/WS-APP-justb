<div class="os-categories-ordering-w" data-category-order-update-route="<?php echo OsRouterHelper::build_route_name('service_categories', 'udpate_order_of_categories'); ?>">
	...
	<div class="latepoint-message latepoint-message-subtle">Pour partager des heures à tarifs préférentiels avec vos clients, créez la catégorie 'Happy Hours', elle sera visible pour les clients dans l'application et vous pourrez lui associer des services au prix de votre choix</div>
