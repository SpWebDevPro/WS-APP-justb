    ...
    <div class="os-form-content">
                ...
                if($service_categories){
                  foreach($service_categories as $service_category){
                    if(is_array($service_category->services)){
                      echo '<div class="os-option-group">'.$service_category->name.'</div>';
                  ...
                  if($uncategorized_services){
                    echo '<div class="os-option-group">'.__('Uncategorized', 'latepoint').'</div>';
      ...
      <div class="os-service-durations" style="<?php echo ($booking->service_id && count($booking->service->get_all_durations_arr()) > 1) ? '' : 'display: none;'; ?>">
        <div class="os-form-group os-form-select-group os-form-group-transparent">
          ...
          <select class="os-form-control os-affects-duration" name="" id="">
            <?php if($booking->service_id){ 
      ...
      <div class="os-row">
        <div class="os-col-12">
          <?php echo OsFormHelper::textarea_field('booking[customer_comment]', __('Booking Comment', 'latepoint'), $booking->customer_comment); ?>
        </div>
      </div>
