  ...
  <form action="" data-os-action="<?php echo OsRouterHelper::build_route_name('settings', 'update'); ?>">
    <div class="os-tp-box">
      ...
      <div class="os-tp-box-content">
        ...
        <div class="latepoint-message latepoint-message-subtle">Conseil : ne pas dépasser 140 caractères. Testez &nbsp<a href="https://www.textmagic.com/free-tools/sms-length-calculator" target="_blank"> ici</a> &nbsp la longueur de votre SMS, en gardant à l'esprit que vos variables seront remplacées par leur contenu.</div>
