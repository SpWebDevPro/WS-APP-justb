...
//based on latepoint Version: 2.2.1.1
...
final class LatePoint {
   ...
   *
   */
  public $version = '2.2.1.1';
  public $db_version = '1.2.6';
  ...
  public function init_hooks() {
   ...
   /*  OsStepsHelper::init_step_actions(); */
    BookAppOsStepsHelper::init_step_actions();
  ...
  /*   OsRouterHelper::call_by_route_name($route_name, OsRouterHelper::get_request_param('return_format', 'json')); */
  }
  ...
  */
  public function load_admin_scripts_and_styles() {
    ...
    //Sandy
    wp_enqueue_style( 'bookapp', $this->public_stylesheets() . 'bookapp.css' );
